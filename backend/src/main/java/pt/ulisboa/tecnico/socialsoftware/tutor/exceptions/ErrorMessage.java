...
public enum ErrorMessage {
    ...
    AT_LEAST_TWO_CORRECT_OPTIONS_NEEDED("Multiple ordered choice questions need to have at least 2 correct options"),
    RELEVANCE_FOR_CORRECT_OPTIONS_NEEDED("Correct options need relevance other than 0"),
    RELEVANCE_FOR_WRONG_OPTIONS_NOT_NEEDED("Wrong options cannot have relevance"),
